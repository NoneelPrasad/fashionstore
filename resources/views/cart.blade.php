                ...
                <tbody>
                  ...
                  <tr>
                      <td class="product-thumbnail">
                        <img src="{{url($item['product']->imageURL)}}" alt="Image" class="img-fluid">
                      </td>
                      <td class="product-name">
                      <h2 class="h5 text-black">{{$item['product']->productDisplayName}}</h2>
                      </td>
                    ...
                    <td><a href="{{url('dropitem?ID='.$item['product']->ID)}}" class="btn btn-primary btn-sm">X</a></td>
                    </tr>
